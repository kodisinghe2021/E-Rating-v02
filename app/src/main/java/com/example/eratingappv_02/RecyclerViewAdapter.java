...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.RVAHolder> {
    String s1[], s2[], image_main_url[],image_logo_url[];
    Context context;

    public RecyclerViewAdapter(Context context, String[] s1, String[] s2,String image_main_url[],String image_logo_url[]) {
        this.s1 = s1;
        this.s2 = s2;
